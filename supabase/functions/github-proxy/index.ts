  ...
  try {
    ...
    switch (action) {
      ...
      case "delete_file": {
        ...
        return json(
          await ghFetch("DELETE", `${base}/contents/${path}`, GITHUB_TOKEN, body),
        );
      }
      ...
      case "commits": {
        ...
        return json(
          await ghFetch(
            "GET",
            `${base}/commits?sha=${sha}&per_page=${perPage}&page=${page}`,
            GITHUB_TOKEN,
          ),
        );
      }
      case "commit": {
        ...
        return json(
          await ghFetch("GET", `${base}/commits/${sha}`, GITHUB_TOKEN),
        );
      }
      ...
      case "branches":
        return json(
          await ghFetch("GET", `${base}/branches?per_page=100`, GITHUB_TOKEN),
        );
      case "get_ref": {
        const ref = url.searchParams.get("ref") || "heads/main";
        return json(
          await ghFetch("GET", `${base}/git/ref/${ref}`, GITHUB_TOKEN),
        );
      }
      case "create_ref": {
        ...
        const body = await req.json();
        return json(
          await ghFetch("POST", `${base}/git/refs`, GITHUB_TOKEN, {
            ref,
            ...body,
          }),
        );
      ...
      case "update_ref": {
        ...
        const body = await req.json();
        return json(
          await ghFetch("PATCH", `${base}/git/refs/${ref}`, GITHUB_TOKEN, body),
        );
      }
      ...
      case "create_blob": {
        const body = await req.json();
        return json(
          await ghFetch("POST", `${base}/git/blobs`, GITHUB_TOKEN, body),
        );
      }
      case "create_tree": {
        const body = await req.json();
        return json(
          await ghFetch("POST", `${base}/git/trees`, GITHUB_TOKEN, body),
        );
      }
      case "create_commit": {
        const body = await req.json();
        return json(
          await ghFetch("POST", `${base}/git/commits`, GITHUB_TOKEN, body),
        );
      }
      ...
      case "issue": {
        ...
        return json(
          await ghFetch("GET", `${base}/issues/${num}`, GITHUB_TOKEN),
        );
      }
      case "create_issue": {
        const body = await req.json();
        return json(
          await ghFetch("POST", `${base}/issues`, GITHUB_TOKEN, body),
        );
      }
      case "update_issue": {
        const num = url.searchParams.get("issue_number");
        ...
        const body = await req.json();
        return json(
          await ghFetch("PATCH", `${base}/issues/${num}`, GITHUB_TOKEN, body),
        );
      }
      case "issue_comments": {
        const num = url.searchParams.get("issue_number");
        ...
        return json(
          await ghFetch(
            "GET",
            `${base}/issues/${num}/comments?per_page=100`,
            GITHUB_TOKEN,
          ),
        );
      }
      case "labels":
        return json(
          await ghFetch("GET", `${base}/labels?per_page=100`, GITHUB_TOKEN),
        );
      ...
      case "milestones": {
        ...
        return json(
          await ghFetch(
            "GET",
            `${base}/milestones?state=${state}&per_page=100`,
            GITHUB_TOKEN,
          ),
        );
      }
      case "create_milestone": {
        const body = await req.json();
        return json(
          await ghFetch("POST", `${base}/milestones`, GITHUB_TOKEN, body),
        );
      }
      ...
      case "pulls": {
        ...
        return json(
          await ghFetch(
            "GET",
            `${base}/pulls?state=${state}&per_page=${perPage}`,
            GITHUB_TOKEN,
          ),
        );
      }
      case "pull": {
        ...
        return json(
          await ghFetch("GET", `${base}/pulls/${num}`, GITHUB_TOKEN),
        );
      }
      case "pull_files": {
        const num = url.searchParams.get("pull_number");
        ...
        return json(
          await ghFetch(
            "GET",
            `${base}/pulls/${num}/files?per_page=100`,
            GITHUB_TOKEN,
          ),
        );
      }
      case "pull_reviews": {
        ...
        if (!num) return json({ error: "Missing pull_number" }, 400);
        return json(
          await ghFetch("GET", `${base}/pulls/${num}/reviews`, GITHUB_TOKEN),
        );
      }
      case "pull_comments": {
        const num = url.searchParams.get("pull_number");
      ...
      case "create_pull": {
        const body = await req.json();
        return json(
          await ghFetch("POST", `${base}/pulls`, GITHUB_TOKEN, body),
        );
      }
      case "merge_pull": {
        const num = url.searchParams.get("pull_number");
      ...
      case "update_pull": {
        ...
        const body = await req.json();
        return json(
          await ghFetch("PATCH", `${base}/pulls/${num}`, GITHUB_TOKEN, body),
        );
      }
      ...
      case "search_code": {
        ...
        return json(
          await ghFetch(
            "GET",
            `/search/code?q=${encodeURIComponent(fullQ)}&per_page=${perPage}`,
            GITHUB_TOKEN,
          ),
        );
      }
      ...
      case "collaborators":
        return json(
          await ghFetch(
            "GET",
            `${base}/collaborators?per_page=100`,
            GITHUB_TOKEN,
          ),
        );
      case "assignees":
