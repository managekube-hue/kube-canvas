...
export default function SolutionSme() {
  return <ServiceDetailPage
    ...
    sections={[
      { title: "SME Features", items: ["Customizable module configurations", "Hybrid managed services (co-managed)", "Dedicated account management", "Advanced reporting and analytics"] },
