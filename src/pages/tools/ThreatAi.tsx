      ...
      {!gateUnlocked && (
        <section className="section-warm-gray py-20 lg:py-28">
          <div className="max-w-xl mx-auto px-6 lg:px-12 text-center">
            ...
            <h2 className="text-title mb-4">Unlock Free Threat Intelligence</h2>
            <p className="text-muted-foreground mb-8">
              Enter your details below to access our CVE/EPSS vulnerability lookup and downloadable threat reports.
            </p>
            <form onSubmit={handleLeadSubmit} className="flex flex-col gap-4 text-left">
              ...
              <p className="text-xs text-muted-foreground text-center">
                Your data is never shared. See our <a href="/privacy" className="underline">Privacy Policy</a>.
              </p>
            </form>
          </div>
        </section>
